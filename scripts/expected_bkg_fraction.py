...
def main(A_Ho, R_t, L_t, bkg, ROI, m_nu, Q):
    f_pu = (stats.poisson.pmf(1, R_t * A_Ho)) / (stats.poisson.pmf(0, L_t * A_Ho))
...
if __name__ == "__main__":
    ...
    main(args.A_Ho, args.R_t, args.L_t, args.bkg, args.ROI, args.m_nu, args.Q)